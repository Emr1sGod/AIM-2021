...
namespace Error
{
	...
	ERROR errors[ERROR_MAX_ENTRY] =
	{
		...
		ERROR_ENTRY(120,"LEXICAL: Недопустимое значение целочисленного литерала"),
		...
		ERROR_ENTRY(131,"SYNTAX: Ошибка в структуре блока"),
		...
		ERROR_ENTRY(137,"SYNTAX: Ошибка в параметрах конструкции"),
		ERROR_ENTRY(138,"SYNTAX: Ожидался условный оператор"),
		ERROR_ENTRY_NODEF(139),
		ERROR_ENTRY_NODEF10(140),
		ERROR_ENTRY(150,"SEMANTICS: Функция major должна быть определена только 1 раз"),
		ERROR_ENTRY(151,"SEMANTICS: Определение функции major не обнаруженo"),
		...
		ERROR_ENTRY(163,"SEMANTICS: Параметры цикла могут быть только типа brief"),
		ERROR_ENTRY(165,"SEMANTICS: Вложенные циклы не поддерживаются"),
		ERROR_ENTRY(166,"SEMANTICS: Параметры условного оператора должны быть типа brief"),
